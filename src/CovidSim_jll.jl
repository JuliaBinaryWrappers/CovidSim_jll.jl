...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CovidSim_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("92030e89-47b9-539d-8d6b-4ba272750b96"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CovidSim", artifacts_toml) for e in artifacts["CovidSim"]]
...
if best_platform === nothing
    @debug("Unable to load CovidSim; unsupported platform $(triplet(platform_key_abi()))")
else
